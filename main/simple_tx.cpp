...
inline void delay(uint16_t ms) { vTaskDelay(pdMS_TO_TICKS(ms)); }
...
void uwb_task(void* arg) {
  printf("\nStart FreeRTOS implementation of: %s\n", APP_NAME);
...
extern "C" void app_main() {
  // Tasks für verschiedene Funktionen erstellen
